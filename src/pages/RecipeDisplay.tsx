              ...
              <div className="space-y-4">
                ...
                <Collapsible className="border rounded-md overflow-hidden">
                  <CollapsibleTrigger className="flex justify-between items-center w-full p-3 bg-culinary-light/20">
                    <h3 className="text-md font-medium text-culinary-primary">Ingrédients</h3>
                ...
                <Collapsible className="border rounded-md overflow-hidden">
                  <CollapsibleTrigger className="flex justify-between items-center w-full p-3 bg-culinary-light/20">
                    <h3 className="text-md font-medium text-culinary-primary">Ustensiles</h3>
                    <ChevronDown className="h-4 w-4 text-culinary-primary collapsible-icon" />
                  </CollapsibleTrigger>
                  <CollapsibleContent className="p-3 text-sm">
                ...
                <Collapsible className="border rounded-md overflow-hidden" open={openNutrition} onOpenChange={setOpenNutrition}>
                  <CollapsibleTrigger className="flex justify-between items-center w-full p-3 bg-culinary-light/20">
                    <h3 className="text-md font-medium text-culinary-primary">Valeurs Nutritionnelles</h3>
                    {openNutrition ? (
                  ...
                  <CollapsibleContent className="p-3 text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="flex justify-between">
                        <span>Calories:</span>
                        <span className="font-medium">{recipe.valeurs_nutritionnelles.calories}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Protéines:</span>
                ...
                <div className="border rounded-md overflow-hidden">
                  <div className="p-3 bg-culinary-light/20">
                    <h3 className="text-md font-medium text-culinary-primary">Instructions</h3>
                  </div>
                  <div className="p-3">
